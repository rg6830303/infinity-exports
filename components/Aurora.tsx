...
export default function Aurora({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      <div
        className="absolute right-[-12%] top-[6%] h-[38rem] w-[38rem] animate-aurora rounded-full bg-[radial-gradient(circle_at_center,rgba(26,63,230,0.22),transparent_60%)] blur-3xl"
